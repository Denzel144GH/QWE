					...
					@for ($i = 1; $i <= $seance->Halls->first()->countRows; $i++)
						<tr id='table-screen-row'>
							@for ($j = 1; $j <= $seance->Halls->first()->countColumns; $j++)
								<td>
									@if($i == 5 && $j >= 5 && $j <= 12) <img src="https://sun9-22.userapi.com/impg/vILdjT9oDMVH5IrpedXezCY0Bb98tneHuRfjMg/TtmzCOL8xfA.jpg?size=19x19&quality=96&sign=2551c3bfd1f95d2eb5e9035fa120a1d1&type=album" height="20" width="20"></img>
										@else
